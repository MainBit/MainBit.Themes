...
namespace MainBit.Themes.Migrations {
    public class ExtraOptionsMigrations : DataMigrationImpl
    {

        public int Create() {

            ContentDefinitionManager.AlterPartDefinition("ExtraThemeOptions", builder => builder
                .WithDescription("Add extra options to theme."));

            ContentDefinitionManager.AlterTypeDefinition("ExtraThemeOptions",
                cfg => cfg
                    .WithPart("ExtraThemeOptions")
                    .WithPart("CommonPart", p => p.WithSetting("OwnerEditorSettings.ShowOwnerEditor", "false"))
                );

            SchemaBuilder.CreateTable("ExtraThemeOptionsPartRecord",
                table => table
                    .ContentPartRecord()
                    .Column<string>("Type", column => column.NotNull().WithDefault(""))
